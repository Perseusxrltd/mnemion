...
from mempalace.config import DRAWER_HNSW_METADATA, MempalaceConfig  # noqa: E402
...
def collection(palace_path):
    ...
    col = client.get_or_create_collection("mempalace_drawers", metadata=DRAWER_HNSW_METADATA)
    yield col
