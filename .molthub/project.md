...
latest_milestone: "v3.5.1 — MemPalace catch-up, storage repair hardening, sweeper ingestion, query sanitizer, and moat evidence cleanup (May 2026)"
---
...
- `plugin.json` + `marketplace.json`: registers Mnemion as a Claude Code plugin (v3.5.1).
...
- `plugin.json`: registers Mnemion as an OpenAI Codex CLI plugin (v3.5.1).
