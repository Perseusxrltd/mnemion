...
| `trust_lifecycle.py` | **Memory Trust Layer** — SQLite trust records per drawer; status lifecycle (current→superseded\|contested→historical); confidence scoring; conflict registry; append-only audit trail |
