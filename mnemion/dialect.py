...
Adapted for mnemion: works standalone on plain text and ChromaDB drawers.
No dependency on palace_graph.py or layers.py.
...
class Dialect:
    ...
    # === PLAIN TEXT COMPRESSION (new for mnemion) ===
