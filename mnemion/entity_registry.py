#!/usr/bin/env python3
"""
entity_registry.py — Persistent personal entity registry for Mnemion.
...
def _wikipedia_lookup(word: str) -> dict:
    ...
    try:
        ...
        req = urllib.request.Request(url, headers={"User-Agent": "Mnemion/1.0"})
...
class EntityRegistry:
    ...
    Stored at ~/.mnemion/entity_registry.json
    Schema:
    {
    ...
    DEFAULT_PATH = Path.home() / ".mnemion" / "entity_registry.json"
    ...
    def learn_from_text(self, text: str, min_confidence: float = 0.75) -> list:
        ...
        """
        from mnemion.entity_detector import extract_candidates, score_entity, classify_entity
