...
When the user wants to search their Mnemion memories, follow these steps:
...
- mnemion_get_taxonomy -- Retrieve the full wing/room/drawer tree. Use when
  the user wants an overview of their entire memory structure.
- mnemion_traverse(room) -- Walk the knowledge graph starting from a room.
  Use when the user wants to explore connections and related memories.
- mnemion_find_tunnels(wing1, wing2) -- Find cross-wing connections (tunnels)
