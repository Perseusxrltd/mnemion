#!/usr/bin/env python3
"""
layers.py — 4-Layer Memory Stack for mnemion
===================================================
...
Reads directly from ChromaDB (mnemion_drawers)
and ~/.mnemion/identity.txt.
"""
...
class Layer0:
    ...
    Reads from ~/.mnemion/identity.txt — a plain-text file the user writes.
    ...
    def __init__(self, identity_path: str = None):
        if identity_path is None:
            identity_path = os.path.expanduser("~/.mnemion/identity.txt")
    ...
    def render(self) -> str:
        ...
        if os.path.exists(self.path):
            ...
            self._text = "## L0 — IDENTITY\nNo identity configured. Create ~/.mnemion/identity.txt"
...
class Layer1:
    ...
    def generate(self) -> str:
        ...
        try:
            ...
            col = get_backend(anaktoron_path=self.anaktoron_path).get_collection(
